...
<head>
    ...
    <style>
        ...
        * {
        ...
        .ba{
            background-color:rgba(124, 123, 123, 0.099);
        }
        .heading {
            text-align: center;
            padding: 2rem 0;
    ...
    <section>
        <div class="">
            <form method="POST" class="contenu">
                <fieldset class="">
                    <br>
                    <legend align="center" class="title">Contactez-nous </legend>
                    <div class="">
                        <div>
                            <textarea class="ba" name="text" id="" cols="60" rows="10" placeholder="entrer votre message." border='1'></textarea>
                        </div>
                        <br>
                        <div>
                            <button><a class="lien" href="msg.html">Envoyer</a></button>
                        </div>
                    </div>
                    </fieldset>
            </form>
