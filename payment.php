		...
		<div class="contenu">
			<form method="POST" class="col-md-4 col-md-offset-6">
				<fildset class="scheduler-border">
					<legend align="center" class="title">Paiement </legend>
					<div class="container">
						<div>
							<label for="exampleInputEmail1">Non complet </label>
							<input type="text" name="login"  placeholder="ex helen" id="exampleInputEmail1" aria-describedby="emailHelp">
						</div>
						<div>
							<label for="exampleInputPassword1">Email :</label>
							<input type="email" placeholder="ex nom@gmail.com"  name="mdp" id="exampleInputPassword1">
						</div>
						<div>
							<label for="exampleInputPassword1">Numero de carte :</label>
							<input type="number" placeholder="ex 4763.." name="mdp" id="exampleInputPassword1">
						</div>
						<div>
							<label for="exampleInputPassword1">PIN :</label>
							<input type="password" placeholder="******" name="mdp" id="exampleInputPassword1">
							
						</div>

						<br>
						<div>
							<button><a class="lien" href="thankyou.php">acheter</a></button>
						</div>
					</div>
					</fieldset>
			</form>
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		try {
			...
			if ($nb === 1) {
				...
				header("Location:signin.php?err=lm");
			}
